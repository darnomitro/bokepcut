...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepcut.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'tWcGNUd2FJqvJ6Mw3nVt76CmFPVBOZK471TxE656lFE',
        yandex: '722d359e74bb30c8',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "logo": "https://bokepcut.pages.dev/favicon.ico",
        "url": "https://bokepcut.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokepcut.pages.dev"
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepcut.pages.dev/?q={search_term}", 
